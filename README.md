...
1. **先翻[《玩家急救手冊》](https://minijinai75.notion.site/mini-mvu-userhelpr)**——狀態欄不動、數值凍結、格式跑掉、回覆被切一半……多數狀況照手冊就能自救，不用等我。也可以把手冊全文丟給你自己的 AI 當除錯嚮導。
2. 確認你的卡是不是最新版（對一下 `character_version`），八成更新就好了。
3. 還是不行就到 Discord 告訴我：卡名＋版本號＋截圖（手冊最下面有回報模板，照填最快被修好）。
